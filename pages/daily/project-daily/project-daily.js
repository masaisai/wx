// pages/daily/project-daily/project-daily.js
const app = getApp()
Page({
  ...
  onShow() {
    ...
    var params = 'pageIndex=' + this.data.pageIndex + '&pageSize=' + this.data.pageSize + '&proid=' + this.data.proid;
    ...
    if (direction == 1) {
      ...
      if ((e.detail.current - subSize) % (_this.data.pageSize) == 0) {
        if (e.detail.current != _this.data.currentIndex) {
          ...
          var params = 'pageIndex=' + _this.data.pageIndex + '&pageSize=' + _this.data.pageSize + '&proid=' + _this.data.proid;
  ...
  inputConfirm(e) {
    wx.navigateTo({
      url: "../../search/project-daily-search/project-daily-search?key=" + e.detail.value+'&proid='+this.data.proid
    })
  },
  search() {
