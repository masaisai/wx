// pages/search/project-daily-search/project-daily-search.js
const app = getApp()
Page({
  data: {
    type: '',
  ...
  onShow(options) {
    ...
    if (this.data.usercode) {
      var params = 'pageIndex=' + this.data.pageIndex + '&pageSize=' + this.data.pageSize + '&usercode=' + this.data.usercode+'&proid'+this.data.proid;
      this.loadData(params);
    }
  },
    ...
    if (direction == 1) {
      ...
      if ((e.detail.current - subSize) % (_this.data.pageSize) == 0) {
        if (e.detail.current != _this.data.currentIndex) {
          ...
          var params = 'pageIndex=' + _this.data.pageIndex + '&pageSize=' + _this.data.pageSize + '&usercode=' + _this.data.usercode + '&proid' + _this.data.proid;
